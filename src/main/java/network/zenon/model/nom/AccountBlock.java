...
public class AccountBlock extends AccountBlockTemplate {
    ...
    public AccountBlock(JAccountBlock json) {
        ...
        this.descendantBlocks =
        		Collections.unmodifiableList(json.descendantBlocks.stream().map(x -> new AccountBlock(x)).toList());
        ...
        this.confirmationDetail = json.confirmationDetail != null 
        		...
        		: null;
        this.pairedAccountBlock = json.pairedAccountBlock != null 
        		? new AccountBlock(json.pairedAccountBlock) 
        		: null;
    }
