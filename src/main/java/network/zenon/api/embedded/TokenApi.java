...
public class TokenApi {
    ...
    public TokenList getAll(int pageIndex, int pageSize) {
    	JTokenList response = this.client.sendRequest("embedded.token.getAll", new Object[] { pageIndex, pageSize }, JTokenList.class);
    ...
    public TokenList getByOwner(Address address, int pageIndex, int pageSize) {
    	JTokenList response = this.client.sendRequest("embedded.token.getByOwner", new Object[] { address.toString(), pageIndex, pageSize }, JTokenList.class);
        return new TokenList(response);
    }

    public Token getByZts(TokenStandard tokenStandard) {
    	JToken response = this.client.sendRequest("embedded.token.getByZts", new Object[] { tokenStandard.toString() }, JToken.class);
    ...
    public AccountBlockTemplate issueToken(String tokenName, String tokenSymbol, String tokenDomain,
        ...
        boolean mintable, boolean burnable, boolean utility) {
    ...
    public AccountBlockTemplate updateToken(TokenStandard tokenStandard, Address owner, boolean isMintable, boolean isBurnable) {
    	throw new UnsupportedOperationException();
    }
}
