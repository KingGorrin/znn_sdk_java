...
public class StakeApi {
    ...
    public StakeList getEntriesByAddress(Address address, int pageIndex, int pageSize) {
    	JStakeList response = this.client.sendRequest("embedded.stake.getEntriesByAddress", new Object[] { address.toString(), pageIndex, pageSize }, JStakeList.class);
        return new StakeList(response);
    }

    public UncollectedReward getUncollectedReward(Address address) {
    	JUncollectedReward response = this.client.sendRequest("embedded.stake.getUncollectedReward", new Object[] { address.toString() }, JUncollectedReward.class);
    ...
    public RewardHistoryList getFrontierRewardByPage(Address address, int pageIndex, int pageSize) {
    	JRewardHistoryList response = this.client.sendRequest("embedded.stake.getFrontierRewardByPage", new Object[] { address.toString(), pageIndex, pageSize }, JRewardHistoryList.class);
