...
public class PillarApi {
    ...
    public long getDepositedQsr(Address address) {
        return this.client.sendRequest("embedded.pillar.getDepositedQsr", new Object[] { address.toString() }, long.class);
    }

    public UncollectedReward getUncollectedReward(Address address) {
    	JUncollectedReward response = this.client.sendRequest("embedded.pillar.getUncollectedReward", new Object[] { address.toString() }, JUncollectedReward.class);
    ...
    public RewardHistoryList getFrontierRewardByPage(Address address, int pageIndex, int pageSize) {
    	JRewardHistoryList response = this.client.sendRequest("embedded.pillar.getFrontierRewardByPage", new Object[] { address.toString(), pageIndex, pageSize }, JRewardHistoryList.class);
    ...
    public PillarInfoList getAll(int pageIndex, int pageSize) {
    	JPillarInfoList response = this.client.sendRequest("embedded.pillar.getAll", new Object[] { pageIndex, pageSize }, JPillarInfoList.class);
    ...
    public PillarInfo getByName(String name) {
    	JPillarInfo response = this.client.sendRequest("embedded.pillar.getByName", new Object[] { name }, JPillarInfo.class);
    ...
    public DelegationInfo getDelegatedPillar(Address address) {
    	JDelegationInfo response = this.client.sendRequest("embedded.pillar.getDelegatedPillar", new Object[] { address.toString() }, JDelegationInfo.class);
    ...
    public PillarEpochHistoryList getPillarEpochHistory(String name, int pageIndex, int pageSize) {
    	JPillarEpochHistoryList response = this.client.sendRequest("embedded.pillar.getPillarEpochHistory", new Object[] { name, pageIndex, pageSize }, JPillarEpochHistoryList.class);
    ...
    public PillarEpochHistoryList getPillarsHistoryByEpoch(int epoch, int pageIndex, int pageSize) {
    	JPillarEpochHistoryList response = this.client.sendRequest("embedded.pillar.getPillarsHistoryByEpoch", new Object[] { epoch, pageIndex, pageSize }, JPillarEpochHistoryList.class);
        return new PillarEpochHistoryList(response);
    }
