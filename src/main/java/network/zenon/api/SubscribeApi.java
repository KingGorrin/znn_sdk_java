...
public class SubscribeApi {
    ...
    public String toAccountBlocksByAddress(Address address) {
    	return this.client.sendRequest("ledger.subscribe", new Object[] { "accountBlocksByAddress", address.toString() }, String.class);
    }

    public String toUnreceivedAccountBlocksByAddress(Address address) {
    	return this.client.sendRequest("ledger.subscribe", new Object[] { "unreceivedAccountBlocksByAddress", address.toString() }, String.class);
    }
}