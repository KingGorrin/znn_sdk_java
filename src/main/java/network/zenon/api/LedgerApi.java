...
public class LedgerApi {
    ...
    public AccountBlockList getUnconfirmedBlocksByAddress(Address address, int pageIndex, int pageSize) {
        JAccountBlockList response = this.client.sendRequest("ledger.getUnconfirmedBlocksByAddress",
                new Object[] { address.toString(), pageIndex, pageSize }, JAccountBlockList.class);
    ...
    public AccountBlockList getUnreceivedBlocksByAddress(Address address, int pageIndex, int pageSize) {
        JAccountBlockList response = this.client.sendRequest("ledger.getUnreceivedBlocksByAddress",
                new Object[] { address.toString(), pageIndex, pageSize }, JAccountBlockList.class);
        return new AccountBlockList(response);
    }
    ...
    public AccountBlock getFrontierAccountBlock(Address address) {
        JAccountBlock response = this.client.sendRequest("ledger.getFrontierAccountBlock",
                new Object[] { address.toString() }, JAccountBlock.class);
        return response != null ? new AccountBlock(response) : null;
    }

    public AccountBlock getAccountBlockByHash(Hash hash) {
        JAccountBlock response = this.client.sendRequest("ledger.getAccountBlockByHash",
                new Object[] { hash.toString() }, JAccountBlock.class);
        return response != null ? new AccountBlock(response) : null;
    }
    ...
    public AccountBlockList getAccountBlocksByHeight(Address address, int height, int count) {
        JAccountBlockList response = this.client.sendRequest("ledger.getAccountBlocksByHeight",
                new Object[] { address.toString(), height, count }, JAccountBlockList.class);
        return new AccountBlockList(response);
    }
    ...
    /// pageIndex = 0 returns the most recent account blocks sorted descending by
    /// height
    public AccountBlockList getAccountBlocksByPage(Address address, int pageIndex, int pageSize) {
        JAccountBlockList response = this.client.sendRequest("ledger.getAccountBlocksByPage",
                new Object[] { address.toString(), pageIndex, pageSize }, JAccountBlockList.class);
        return new AccountBlockList(response);
    }
    ...
    public Momentum getMomentumBeforeTime(long time) {
        JMomentum response = this.client.sendRequest("ledger.getMomentumBeforeTime", new Object[] { time },
                JMomentum.class);
        return response != null ? new Momentum(response) : null;
    }

    public Momentum getMomentumByHash(Hash hash) {
        JMomentum response = this.client.sendRequest("ledger.getMomentumByHash", new Object[] { hash.toString() },
                JMomentum.class);
        return response != null ? new Momentum(response) : null;
    }
    ...
    public MomentumList getMomentumsByHeight(long height, long count) {
        ...
        JMomentumList response = this.client.sendRequest("ledger.getMomentumsByHeight", new Object[] { height, count },
                JMomentumList.class);
    ...
    public MomentumList getMomentumsByPage(int pageIndex, int pageSize) {
        JMomentumList response = this.client.sendRequest("ledger.getMomentumsByPage",
                new Object[] { pageIndex, pageSize }, JMomentumList.class);
        return new MomentumList(response);
    }
    ...
    public DetailedMomentumList getDetailedMomentumsByHeight(long height, long count) {
        height = height < 1 ? 1 : height;
        count = count > Constants.RPC_MAX_PAGE_SIZE ? Constants.RPC_MAX_PAGE_SIZE : count;
        JDetailedMomentumList response = this.client.sendRequest("ledger.getDetailedMomentumsByHeight",
                new Object[] { height, count }, JDetailedMomentumList.class);
        return new DetailedMomentumList(response);
    }

    public AccountInfo getAccountInfoByAddress(Address address) {
        JAccountInfo response = this.client.sendRequest("ledger.getAccountInfoByAddress",
                new Object[] { address.toString() }, JAccountInfo.class);
