...
public final class SeedCalculatorByWordListLookUp {
     ...
     * is not checked for validity here, for that use a {@link MnemonicValidator}.
     * <p>
     * The purpose of this method is to avoid constructing a mnemonic String if you
     * have gathered a list of words from the user and also to avoid having to
     * normalize it, all words in the {@link WordList} are normalized instead.
     * <p>
     * Due to normalization, the passphrase still needs to be {@link String}, and
     * not {@link CharSequence}, this is an open issue:
     * https://github.com/NovaCrypto/BIP39/issues/7
     *
     * @param mnemonic   The memorable list of words, ideally selected from the word
     *                   list that was supplied while creating this object.
