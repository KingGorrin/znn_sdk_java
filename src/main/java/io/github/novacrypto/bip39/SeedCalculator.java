...
public final class SeedCalculator {
    ...
    /**
     * Creates a seed calculator using {@link SpongyCastlePBKDF2WithHmacSHA512}
     * which is the most compatible. Use
     * {@link SeedCalculator#SeedCalculator(PBKDF2WithHmacSHA512)} to supply
     * another.
     */
     ...
     * <p>
     * Due to normalization, these need to be {@link String}, and not
     * {@link CharSequence}, this is an open issue:
     * https://github.com/NovaCrypto/BIP39/issues/7
     * <p>
     * If you have a list of words selected from a word list, you can use
     * {@link #withWordsFromWordList} then
