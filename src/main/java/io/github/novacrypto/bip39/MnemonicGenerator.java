...
public final class MnemonicGenerator {
     ...
     *
     * @param entropyHex 128-256 bits of hex entropy, number of bits must also be
     *                   divisible by 32
     * @param target     Where to write the mnemonic to
     */
    public void createMnemonic(final CharSequence entropyHex, final Target target) {
     ...
     * Create a mnemonic from the word list given the entropy.
     *
     * @param entropy 128-256 bits of entropy, number of bits must also be divisible
     *                by 32
     * @param target  Where to write the mnemonic to
     */
    public void createMnemonic(final byte[] entropy, final Target target) {
    ...
    private void createMnemonic(final int[] wordIndexes, final Target target) {
